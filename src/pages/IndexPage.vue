...
export default defineComponent({
  ...
  setup () {
    ...
    const columns = [
      ...
      { name: 'title', field: 'title', label: 'Nome', sortable: true, align: 'left' },
      { name: 'author', field: 'author', label: 'Email', sortable: true, align: 'left' },
      { name: 'content', field: 'content', label: 'Telefone', sortable: true, align: 'left' },
